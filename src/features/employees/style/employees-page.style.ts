...
/**
 * Estilos de la pantalla de empleados
 *
 * Mismo esqueleto que la pantalla de categorías: `gap-6` entre el encabezado y
 * el cuerpo —son dos bloques distintos— y `gap-4` dentro del cuerpo, donde
...
/** Pila de la pantalla. */
export const employeesPageVariants = cva([
...
export const employeesPageBodyVariants = cva([
 ...
 * rejilla de categorías, para que todas las pantallas se paginen igual.
 */
export const employeesPagePaginationVariants = cva([
